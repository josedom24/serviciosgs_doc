...
Vamos a estudiar tambíen las distintas configuraciones que podemos realizar para que Apache sea capaz de servir páginas realizadas en PHP y vamos a estudiar las diferencias de rendimientos (uso de memoria y respuestas por segundos) que podemos obtener utilizando las distintas configuraciones: libphp, fastcgi. Por último estudiaremos diferentes aplicaiones que pueden mejorar el rendimiento de nuetro servidor: mceleradores PHP, memcache, varnish, ...
